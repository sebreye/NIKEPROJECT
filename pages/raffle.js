  ...
  return (
    <div>
      <div className='flex justify-around mt-20' style={{height: 700}}>
        ...
        <img src="https://assets.stickpng.com/images/5cb0633d80f2cf201a4c3253.png" alt=""  width={400} className='' style={{position: 'relative', top: -550, }}/>
        </div>
        
        <div className='' style={{width: 350}}>
        <h1 className='text-3xl font-bold my-5'>WHAT'S RAFFLE</h1>
      ...
      <div className='flex justify-around ' style={{height: 750}} >
        ...
        <img src="https://ujasntkfphywizsdaapi.supabase.co/storage/v1/object/public/content/app_screens/23d4608a-7574-4906-b478-74bf26e65717.png" className='relative' alt="" width={295} style={{borderRadius: 20, margin: 'auto'}} />
        <img src="https://assets.stickpng.com/images/5cb0633d80f2cf201a4c3253.png" alt="" className='relative'  width={450} style={{position: 'relative', top: -650, }}/>
